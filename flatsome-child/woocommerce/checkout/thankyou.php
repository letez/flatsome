    ...
    <?php do_action( 'woocommerce_thankyou', $get_order_id ); ?>
		...
		<div class="shop-notice">
			<?php
				...
				if(get_posts($args)) {
					echo do_shortcode( '[block id="shop-notice"]' );
				}
			?>
			</div>			
			<div class="is-well entry-content">
				...
				<a class="button-continue-shopping button primary expand"  href="<?php echo esc_url( apply_filters( 'woocommerce_continue_shopping_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
